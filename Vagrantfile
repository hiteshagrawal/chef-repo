...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "hitesha-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/hitesh-test"
  #   chef.validation_client_name = "hitesh-test-validator"
  #   chef.validation_key_path = ".chef/hitesh-test-validator.pem"
  # end
end
